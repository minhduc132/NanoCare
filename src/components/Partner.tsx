...
const Partner = () => {
    const t = useT();
    return (
        <section className="relative min-h-[800px] sm:min-h-[1200px] lg:min-h-[1600px] overflow-hidden font-[TWFucmwZSFeHRyYUxpZhLnRZg]">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="py-8 sm:py-12 lg:pb-20">
                    ...
                    <div className="relative flex flex-col items-center mb-6 sm:mb-8">
                        ...
                        <h1 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-xl sm:text-2xl lg:text-[28px] text-center leading-[1.6] mt-12 sm:mt-24 lg:mt-[150px] px-4">
                            <span className="text-[rgb(34,34,34)]">{t('partner.title.line1')}</span>{' '}
                            <span className="text-[rgb(225,162,0)]">{t('partner.title.line2')}</span>
                        </h1>
                    </div>

                    {/* Paragraph */}
                    <p className="text-sm sm:text-base text-[rgb(34,34,34)] text-center leading-[1.6] max-w-3xl mx-auto mb-8 sm:mb-10 lg:mb-12 px-4">
                        {t('partner.description')}
                    </p>

                    {/* Map Image */}
                    <div className="flex justify-center px-4">
                        <div className="w-full max-w-4xl h-[250px] sm:h-[300px] lg:h-[400px] bg-cover bg-center rounded-lg" style={{ backgroundImage: 'url(/images/sky1.png)' }}></div>
                    </div>
                </div>
                ...
                <div className="py-8 sm:py-12 lg:pb-20">
                    {/* Title */}
                    <h1 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-xl sm:text-2xl lg:text-[28px] text-center leading-[1.6] mb-8 sm:mb-12 lg:mb-16 px-4">
                        <span className="text-[rgb(34,34,34)]">{t('partner.benefits.title.line1')}</span>{' '}
                        <span className="text-[rgb(225,162,0)]">{t('partner.benefits.title.line2')}</span>
                    </h1>

                    {/* 3 Benefit Blocks */}
                    <div className="flex flex-col sm:flex-row justify-center items-start gap-6 sm:gap-8 lg:gap-12 flex-wrap px-4">
                        {/* Discount */}
                        <div className="flex flex-col items-center w-full sm:w-auto sm:max-w-[320px]">
                            <div className="w-12 h-12 sm:w-[60px] sm:h-[60px] mb-4">
                            ...
                            <h3 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-base sm:text-lg text-[rgb(34,34,34)] text-center leading-[1.6] mb-3">
                                {t('partner.benefit.discount.title')}
                            </h3>
                            <p className="text-sm sm:text-base text-[rgb(34,34,34)] text-center leading-[1.6]">
                                {t('partner.benefit.discount.desc')}
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center w-full sm:w-auto sm:max-w-[320px]">
                            ...
                            <h3 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-base sm:text-lg text-[rgb(34,34,34)] text-center leading-[1.6] mb-3">
                                {t('partner.benefit.marketing.title')}
                            </h3>
                            <p className="text-sm sm:text-base text-[rgb(34,34,34)] text-center leading-[1.6]">
                                {t('partner.benefit.marketing.desc')}
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center w-full sm:w-auto sm:max-w-[320px]">
                            ...
                            <h3 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-base sm:text-lg text-[rgb(34,34,34)] text-center leading-[1.6] mb-3">
                                {t('partner.benefit.technical.title')}
                            </h3>
                            <p className="text-sm sm:text-base text-[rgb(34,34,34)] text-center leading-[1.6]">
                                {t('partner.benefit.technical.desc')}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-6 sm:pt-8 lg:pt-12 pb-4 sm:pb-6 lg:pb-8">
                    <div className="w-full h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[700px] bg-cover" style={{ backgroundImage: 'url(/images/product.png)', backgroundPosition: 'center 80%' }}></div>
                </div>
            </div>
        </section>
    );
