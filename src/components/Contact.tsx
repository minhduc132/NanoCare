    ...
    return (
        <section className="relative min-h-[800px] bg-white">
            <div className="mx-auto max-w-[1200px] px-4 py-16">
                ...
                <div className="flex justify-center items-start gap-24 mb-16">
                    {/* Headquarters */}
                    <div className="flex flex-col ">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-[16px] text-[rgb(225,162,0)] font-medium px-3 py-1 rounded">Headquarters</p>
                        </div>
                    ...
                    <div className="flex flex-col ">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-[16px] text-[rgb(225,162,0)] font-medium">Phone</p>
                        </div>
                    ...
                    <div className="flex flex-col ">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-[16px] text-[rgb(225,162,0)] font-medium">Email</p>
                        </div>
                ...
                <div className="flex gap-12 items-start">
                    ...
                    <div className="flex-1">
                        <h2 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-[24px] text-black text-left leading-[1.6] mb-4">
                            Welcome pharma<br/> retailers, ENT partners,<br/> ODM and distributors.
                        </h2>
                        <p className="text-[16px] text-black text-left leading-[1.6]">
