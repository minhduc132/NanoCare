...
const Partner = () => {
    return (
        <section className="relative min-h-[800px] sm:min-h-[1200px] lg:min-h-[1600px] overflow-hidden font-[var(--font-hind)]">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="pb-8 sm:pb-12 lg:pb-20">
                    ...
                    <div className="relative flex flex-col items-center mb-6 sm:mb-8">
                        ...
                        <h1 className="font-[var(--font-hind)] text-xl sm:text-2xl lg:text-[28px] text-center leading-[1.6] mt-12 sm:mt-24 lg:mt-[150px] px-4">
                ...
                <div className="pt-8 sm:pt-12 lg:pt-20">
                    {/* Title */}
                    <h1 className="font-[var(--font-hind)] text-xl sm:text-2xl lg:text-[28px] text-center leading-[1.6] mb-8 sm:mb-12 lg:mb-16 px-4">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-start gap-6 sm:gap-8 lg:gap-12 flex-wrap px-4">
                        ...
                        <div className="flex flex-col items-start w-full sm:w-auto sm:max-w-[320px]">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <h3 className="font-[var(--font-hind)] font-bold text-base sm:text-lg text-[rgb(225,162,0)] leading-[1.6] whitespace-nowrap">
                                    Discount
                                </h3>
                            </div>
