...
const AdditionalServices = () => {
    return (
        <section className="relative min-h-[470px] bg-white">
            <div className="mx-auto max-w-[1200px] px-4 py-16">
                {/* Headline 22 */}
                <h1 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-[28px] text-[rgb(225,162,0)] text-center leading-[1.6] mt-[40px]">
                    Additional Services<br />
                </h1>

                {/* Container cho 2 services */}
                <div className="flex justify-center items-start gap-16 mt-12">
                    ...
                    <div className="flex flex-col items-center max-w-[400px]">
                        ...
                        {/* Headline 23 */}
                        <h3 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-[20px] text-black text-center leading-[1.6]">
                            Lab Quality Test<br />
                        </h3>
                        {/* Paragraph 8 */}
                        <p className="text-[16px] text-[rgb(34,34,34)] text-center leading-[1.6] mt-4">
                            Quality Test provide at ease, for additional quality assurance
                        </p>
                    </div>
