    ...
    return (
        <section className="relative min-h-[400px] sm:min-h-[470px] bg-white">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
                {/* Headline 22 */}
                <h1 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-xl sm:text-2xl lg:text-[28px] text-[rgb(225,162,0)] text-center leading-[1.6] mt-8 sm:mt-10 lg:mt-[40px]">
                    {t('additional.title')}
                </h1>
                ...
                <div className="flex flex-col sm:flex-row justify-center items-start gap-8 sm:gap-12 lg:gap-16 mt-8 sm:mt-10 lg:mt-12">
                    ...
                    <div className="flex flex-col items-center w-full sm:w-auto sm:max-w-[400px]">
                        ...
                        {/* Headline 23 */}
                        <h3 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-lg sm:text-xl lg:text-[20px] text-black text-center leading-[1.6]">
                            {t('additional.lab.title')}
                        </h3>
                        {/* Paragraph 8 */}
                        <p className="text-sm sm:text-base text-[rgb(34,34,34)] text-center leading-[1.6] mt-3 sm:mt-4 px-4">
                            {t('additional.lab.desc')}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center w-full sm:w-auto sm:max-w-[400px]">
                        ...
                        {/* Headline 24 */}
                        <h3 className="font-[TWFucmwZSFeHRyYUxpZhLnRZg] font-bold text-lg sm:text-xl lg:text-[20px] text-black text-center leading-[1.6]">
                            {t('additional.odm.title')}
                        </h3>
                        {/* Paragraph 9 */}
                        <p className="text-sm sm:text-base text-[rgb(34,34,34)] text-center leading-[1.6] mt-3 sm:mt-4 px-4">
                            {t('additional.odm.desc')}
                        </p>
                    </div>
                </div>
